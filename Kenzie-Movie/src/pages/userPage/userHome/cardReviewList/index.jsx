        ...
        <li className={style.container__review}>
            ...
            <div className={style.container__userReview}>
                ...
                <p className={`${style.user__text} paragraph`}>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Vel eligendi,
                    placeat necessitatibus fuga ad impedit officia molestias consequuntur
                    deserunt animi dolor vitae
                    laboriosam sapiente id quibusdam illo tempore. Corrupti, beatae!</p>
